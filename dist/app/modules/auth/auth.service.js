...
const createAuthUser = (authUser) => __awaiter(void 0, void 0, void 0, function* () {
    const isUserExist = yield users_model_1.User.isUserExist(authUser.email);
    if (isUserExist) {
        throw new ApiError_1.default(http_status_1.default.CONFLICT, 'Your email is already registered');
    }
